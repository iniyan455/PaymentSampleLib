...
public class PaymentActivity extends Activity implements PaymentResultListener {
    ...
    public void startPayment(String name, String description, String image, String currency, String amount, String email, String contact, String prefill) {
        ...
        try {
            ...
            paymentInterface.OnFailureTransaction(e.getMessage());
        }
    }
    ...
    public void onPaymentSuccess(String razorpayPaymentID) {
        try {
            ...
            paymentInterface.onSuccessTransaction(razorpayPaymentID);
        } catch (Exception e) {
    ...
    public void onPaymentError(int code, String response) {
        try {
            ...
            paymentInterface.OnFailureTransaction(response);
        } catch (Exception e) {
